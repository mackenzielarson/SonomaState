...
Author: Msckenzie Larson
Description: This program will compute the area of a square, the area of a circle,
the volume of a cube, the volume of a sphere, and the area of an equilateral triangle given the side length or radius.
"""
...
def main():
    ...
    print("The area of an equilateral triangle with side length ", length, " is ", triangle_area, ".", sep="")
